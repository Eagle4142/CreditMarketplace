...
creditDataProcessed$earliest_cr_line <- as.factor(creditDataProcessed$earliest_cr_line)
...
```
```{r message = FALSE, warning = FALSE}
creditDataProcessed$home_ownership <- as.factor(creditDataProcessed$home_ownership)
...
```{r message = FALSE, warning = FALSE}
library(corrplot)
corrplot(cor(creditDataProcessed), method = "color")
```