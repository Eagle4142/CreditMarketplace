...
top5_namen <- names(top5)
creditDataProcessed$title <- ifelse(creditDataProcessed$title %in% top5_namen, creditDataProcessed$title, 'Other')
```
...
Finally, we can factorise this variable
```{r message = FALSE, warning = FALSE}
creditDataProcessed$combo_zip_addr <- as.numeric(creditDataProcessed$combo_zip_addr)
```
