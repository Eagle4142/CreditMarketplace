...
```{r message = FALSE, warning = FALSE}
plot(creditDataProcessed$revol_util, creditData5$revol_util,
     xlab = "revol_util", 
     ylab = "revol_util",
...
```{r message = FALSE, warning = FALSE}
creditDataProcessed$title <- factor("title")
```
...
Finally, we can factorise this variable
```{r message = FALSE, warning = FALSE}
creditDataProcessed$combo_zip_addr <- factor("combo_zip_addr")
```
